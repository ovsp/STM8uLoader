...
public class STM8uLoader
{
	...
	public static void Main(string[] arg)   { 
		Console.WriteLine(" STM8uLoader - компактный STM8 UART загрузчик/терминал v1425_09.07.2018."); 
		...
		Dumps.read_Key_Open();
			...
			rvsn_byte = Dumps.Load_First_Dump(Dumps.Read_128000v14_25, "Read_128000v14_25");
